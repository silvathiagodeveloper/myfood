...
@section('content_header')
    ...
    <h1>Perfis do Plano {{ $plan->name }}<a href="{{ route('plans.profiles.create', $plan->id) }}" class="btn btn-dark"><i class="fas fa-plus-square"></i> Adicionar</a></h1>
@stop

@section('content')
    <div class="card">
        <div class="card-header">
            <form action="{{ route('plans.profiles.search', $plan->id) }}" method="post">
                @csrf
